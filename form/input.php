...
header('X-FRAME-OPTIONS:DENY');                           // クリックジャッキングをさせないため
// スーパーグロール変数 php 9種類
// 連想配列
if(!empty($_POST)){
  echo '<pre>';
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
      ...
      <input class="btn btn-info" type="submit" name="btn_submit" value="送信する">
...
if(!isset($_SESSION['csrfToken'])){
  $csrfToken = bin2hex(random_bytes(32));         // 暗号論的に安全な、擬似ランダムなバイト列を生成。トークンとして扱う
...
性別
    <div class="form-check form-check-inline">
      ...
      <input class="form-check-input ml-1" type="radio" name="gender" value="1"
    ...
    <div class="form-check">
      ...
      <label class="form-check-label" for="caution">注意事項にチェックする
    </div>
